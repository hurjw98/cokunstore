...
public class ServletAppContext implements WebMvcConfigurer {
	...
	/*
	 * @Bean public MapperFactoryBean<ReviewMapper>
	 * getReviewMapper(SqlSessionFactory factory) throws Exception {
	 * MapperFactoryBean<ReviewMapper> factoryBean = new
	 * MapperFactoryBean<>(ReviewMapper.class);
